...
const RootLayout = ({ children }) => {
  return (
    <html lang="en">
      <body className="flex flex-col lg:flex-row lg:gap-4 container max-w-screen-xl mx-auto font-poppins bg-zinc-900 scroll-smooth scrollbar-thin scrollbar-thumb-rounded-md scrollbar-thumb-zinc-600 scrollbar-track-transparent overflow-x-hidden overflow-y-scroll">
        {children}
        <Analytics />
      </body>
    </html>
